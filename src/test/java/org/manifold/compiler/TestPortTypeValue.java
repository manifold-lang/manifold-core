...
public class TestPortTypeValue {
  ...
  public void testGetSupertype() {
    PortTypeValue pBase = new PortTypeValue(noAttributes);
    PortTypeValue pDerived = new PortTypeValue(noAttributes, pBase);
  ...
  public void testInheritedAttributes() {
    PortTypeValue pBase =
        new PortTypeValue(ImmutableMap.of("u", boolType));
    PortTypeValue pDerived =
        new PortTypeValue(ImmutableMap.of("v", intType), pBase);
